    ...
    <div className="border igem-footer">
      <div className="row flex-center">
        <div className="sm-6 col" style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
          <img style={{border: "none"}} src="https://static.igem.wiki/teams/4173/wiki/wiki/footer2.png"></img>
        </div>
        <div className="sm-3 col">
          <h3>Contact Us</h3>
          <p>Email: <a href="mailto:igem_nju_china@163.com">igem_nju_china@163.com</a></p>
