...
While we were selecting the vector for drug delivery at the beginning, sEV caught our sight. But this was followed by the question of why using sEVs rather than synthetic liposomes. We consulted Manager Zhao and Professor Jiang Xiaohong about the comparison between sEVs and liposomes. Manager Zhao said that liposomes are usually used in situ administration or can target at parenchymal hepatic cells, the target ability was poor; The types of drugs embedded in liposomes are relatively simple, generally nucleic acid drugs;Liposomes also have safety problems in terms of immunogenicity and toxicity. In contrast, sEVs can be recycled to different compartments with a wide delivery range and have good biocompatibility. In addition, more complex engineering transformation can take place on sEVs, which means sEVs have better scalability. 

Professor Jiang also mentioned that though liposomes can deliver siRNA into cells in large quantities, most of the siRNA were then consumed by lysosomes and degraded. Since sEVs were part of our natural delivery system, cells could apply their own tools to utilize molecules wrapped in sEVs, the efficiency of which was relatively high.

### How we respond to our HP

We chose to use sEVs as the vector for drug delivery for its high delivery efficiency ,good biocompatibility and better scalability.

## Design

### How our HP shape our project

During the design process, we consulted experts in the field of sEVs and alopecia to refine our experimental design. Professor Zheng Lei suggested that we should consider how to wrap mRNA into sEVs since it was bigger in size than siRNA, which was taken into careful consideration. After we came up with a solution, Dr. Fu Qingling then pointed out that experiments were required to test whether mRNA was attached to the outer or inner memberane of the sEVs. She also recommended that we use nested PCR to examine the content of mRNA in sEVs, which was very helpful for us.

### How we respond to our HP

We looked up in literature and found that L7ae can be used to connect mRNA to the CD63 on the sEV memberane and refined our design accordingly. Also, we planned to cultivate sEVs with RNase to test whether mRNA was wrapped into the sEVs successfully. Nested PCR was also applied in our experiments and achieved good results.
...
We used BLAST to prove that the siRNA that we designed have low off-target effect so its safety could be guaranteed.

## Model

### How our HP shape our project

After we received the results of questionnaires on the public's views of aesthetic medicine and alopecia products, we conducted multiple regression models to predict the outcome of people's acceptance of new method based on the value of the rest answers. An equation was obtained from the analysis: 
...
We planned to place our product in the aesthetic medicine market and then distributed a questionnaire to understand how the public view aesthetic medicine. In our future plans, we also hoped to build a "sEV+microneedle" delivery system to deal with more skin diseases such as psoriasis.
`
