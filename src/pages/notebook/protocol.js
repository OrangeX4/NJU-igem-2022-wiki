...
(6) Filter the solution with 0.22μm filter;

(3) Continuously add the solution to the ultrafiltration column, centrifuge at 3000rcf for 30min at 4℃ until the solution was concentrated to 1mL ;

(4) Transfer the solution to a new EP tube, add 500μL Total Exosome Isolation, mix them well, and place the tube overnight at 4℃;

(5) Centrifuge at 10000rcf for 1h at 4℃, abandon the supernatant, add 100μL filtered PBS and resuspend the sediment.
...
(1) Prime the tubing with water to avoid air going through the column. To remove ethanol

and avoid precipitation of buffer salts, wash the column with 2 column volumes (CVs) of Milli-Q water at a flow rate of 3 mL/min and pressure threshold set at 0.5 MPa (sample valve set to buffer, wash valve set to column and outlet valve set to waste).

(2) Prime the column with 5 CVs of filtered 0.01 M PBS or in the buffer in which the sample is diluted in, with a flow rate of 2–3 mL/min. Sample valve set to buffer, wash valve set to

column and outlet valve set to waste.
